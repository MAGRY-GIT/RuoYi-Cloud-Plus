...
//        deviceChannelMapper.offlineByDeviceId(deviceId);
    ...
    public void updateCustomDevice(Device device) {
        Device deviceInStore = deviceMapper.selectById(device.getId());
    ...
    public ResourceBaseInfo getOverview() {
        ...
        List<Device> all = deviceMapper.selectList();
    ...
    @Override
    public TableDataInfo<Device> getAll(PageQuery pageQuery, String query, Boolean status) {
        if (query != null) {
