...
public class DeviceChannelVo  implements Serializable {
	...
	public static DeviceChannelVo decode(Element element) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
		DeviceChannelVo deviceChannel = XmlUtil.elementDecode(element, DeviceChannelVo.class);
	...
	public static DeviceChannelVo decodeWithOnlyDeviceId(Element element) {
