package com.cdzeroly.common.mybatis.geo;

/**
 * @author MGARY
 * @date 2024/11/11 下午2:07
 */
...
public class GeoPointConverter {
     ...
     * Output dimension
     */
    private final int outputDimension = 2;
    ...
    public byte[] to(GeoPoint geoPoint) {
        ...
        Coordinate coordinate = new Coordinate(geoPoint.getLng(), geoPoint.getLat());
