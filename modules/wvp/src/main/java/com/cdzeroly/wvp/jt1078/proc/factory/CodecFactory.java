package com.cdzeroly.wvp.jt1078.proc.factory;

import com.cdzeroly.wvp.jt1078.annotation.MsgId;
import com.cdzeroly.wvp.jt1078.proc.request.Re;
import com.cdzeroly.wvp.jt1078.util.ClassUtil;
...
public class CodecFactory {
    ...
    public static void init() {
        ...
        List<Class<?>> classList = ClassUtil.getClassList("com.cdzeroly.wvp.jt1078.proc", MsgId.class);
