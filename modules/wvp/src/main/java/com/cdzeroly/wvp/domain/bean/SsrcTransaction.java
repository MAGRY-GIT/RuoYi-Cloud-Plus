...
public class SsrcTransaction {
    ...
    public static SsrcTransaction buildForDevice(String deviceId, Long channelId, String callId, String stream,
    ...
    public static SsrcTransaction buildForPlatform(String platformId, Long channelId, String callId, String stream,
                                                 String ssrc, String mediaServerId, SIPResponse response, InviteSessionType type) {
        SsrcTransaction ssrcTransaction = new SsrcTransaction();
