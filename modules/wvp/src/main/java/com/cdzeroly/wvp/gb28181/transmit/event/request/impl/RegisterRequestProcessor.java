...
import com.cdzeroly.wvp.gb28181.auth.DigestServerAuthenticationHelper;
import com.cdzeroly.wvp.gb28181.domian.Device;
import com.cdzeroly.wvp.gb28181.domian.bean.GbSipDate;
        ...
        try {
            ...
            if (device != null &&
                ...
                if (registerFlag) {
                    ...
                    device.setTransport(NetProtocol.TCP.name().equalsIgnoreCase(transport) ? NetProtocol.TCP.name() : NetProtocol.UDP.name());
