...
public class PhotoTimeTableController extends BaseController {
    ...
    public R<PhotoTimeTableVo> find(@NotNull(message = "设备ID不能为空") @PathVariable String monitoringDeviceId, PhotoTimeTableDto photoTimeTable ) {
        return R.ok(photoTimeTableService.queryByMonitoringDeviceId(monitoringDeviceId,photoTimeTable));
    }
