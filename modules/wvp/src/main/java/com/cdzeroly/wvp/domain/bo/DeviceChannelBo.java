...
public class DeviceChannelBo   extends BaseEntity {
	...
	public static DeviceChannelBo decode(Element element) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
		DeviceChannelBo deviceChannel = XmlUtil.elementDecode(element, DeviceChannelBo.class);
	...
	public static DeviceChannelBo decodeWithOnlyDeviceId(Element element) {
		Element deviceElement = element.element("DeviceID");
		DeviceChannelBo deviceChannel = new DeviceChannelBo();
