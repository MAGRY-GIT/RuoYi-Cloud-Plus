...
public class StreamContentVo {
    ...
    private StreamContentVo transcodeStream;

    private double progress;

    public StreamContentVo(StreamInfo streamInfo) {
        if (streamInfo == null) {
            return;
        }
        ...
        if (streamInfo.getTranscodeStream() != null) {
            this.transcodeStream = new StreamContentVo(streamInfo.getTranscodeStream());
        }
    }
