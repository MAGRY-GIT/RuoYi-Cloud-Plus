...
public class DeviceChannelServiceImpl implements IDeviceChannelService {
    ...
    private final DeviceMobilePositionMapper deviceMobilePositionMapper;
    ...
    public List<ChannelReduce> queryAllChannelList(String platformId) {
        return channelMapper.queryChannelListInAll(null,null, null, null, platformId, null).getRecords();
    }

    @Override
    public TableDataInfo<ChannelReduce> queryAllChannelList(PageQuery pageQuery, String query, Boolean online, Boolean channelType, String platformId, String catalogId) {
        Page<ChannelReduce> all = channelMapper.queryChannelListInAll(pageQuery.build(),query, online, channelType, platformId, catalogId);
    ...
    public void updateChannelGPS(Device device, DeviceChannel deviceChannel, MobilePosition mobilePosition) {
        if (userSetting.getSavePositionHistory()) {
            deviceMobilePositionMapper.insert(mobilePosition);
        }
    ...
    public void batchAddMobilePosition(List<MobilePosition> mobilePositions) {
        deviceMobilePositionMapper.insert(mobilePositions);
    }
    ...
    public TableDataInfo<DeviceChannel> getSubChannels(int deviceDbId, String channelId, String query, Boolean channelType, Boolean online, PageQuery pageQuery) {
        ...
        Page<DeviceChannel> page = pageQuery.build();
        List<DeviceChannel> all = channelMapper.queryChannels(page,deviceDbId, civilCode, businessGroupId, parentId, query, channelType, online,null);
        return  TableDataInfo.build(all);
    }
    ...
    public List<Device> queryDeviceWithAsMessageChannel() {
        ...
        LambdaQueryWrapper<Device> queryWrapper = Wrappers.lambdaQuery(Device.class)
            .eq(Device::isAsMessageChannel, true);
