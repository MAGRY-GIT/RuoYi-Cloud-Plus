package com.cdzeroly.wvp.streamPush.enent;

import com.alibaba.excel.context.AnalysisContext;
import com.alibaba.excel.event.AnalysisEventListener;
import com.cdzeroly.wvp.streamPush.domian.vo.StreamPushVo;
import com.cdzeroly.wvp.streamPush.bean.StreamPushExcelDto;
...
public class StreamPushUploadFileHandler extends AnalysisEventListener<StreamPushExcelDto> {
     ...
     */
    private final Map<String, StreamPushVo> streamPushItemForSave = new HashMap<>();
    ...
    public void invoke(StreamPushExcelDto streamPushExcelDto, AnalysisContext analysisContext) {
        ...
        streamPushVo.setApp(streamPushExcelDto.getApp());
        streamPushVo.setStream(streamPushExcelDto.getStream());
        streamPushVo.setGbDeviceId(streamPushExcelDto.getGbDeviceId());
        streamPushVo.setGbStatus(streamPushExcelDto.isStatus()?"ON":"OFF");
        streamPushVo.setMediaServerId(defaultMediaServerId);
        streamPushVo.setGbName(streamPushExcelDto.getName());
        streamPushVo.setGbLongitude(streamPushExcelDto.getLongitude());
        streamPushVo.setGbLatitude(streamPushExcelDto.getLatitude());
        streamPushItemForSave.put(streamPushVo.getApp() + streamPushVo.getStream(), streamPushVo);
