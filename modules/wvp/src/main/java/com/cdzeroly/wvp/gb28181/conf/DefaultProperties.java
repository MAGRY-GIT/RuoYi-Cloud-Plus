package com.cdzeroly.wvp.gb28181.conf;

import com.cdzeroly.wvp.gb28181.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
//		 * gov/nist/javax/sip/SipStackImpl.class
        ...
        properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.cdzeroly.wvp.gb28181.conf.StackLoggerImpl");
        properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.cdzeroly.wvp.gb28181.conf.ServerLoggerImpl");
        properties.setProperty("gov.nist.javax.sip.LOG_MESSAGE_CONTENT", String.valueOf(sipLog));
        if (sipLog) {
            log.info("[SIP日志]已开启");
        } else {
            log.info("[SIP日志]已关闭");
